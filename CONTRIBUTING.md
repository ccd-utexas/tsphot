...
If you are not part of the ccd-utexas organization, use the fork-pull collaboration model. On your local fork, branch from and merge back into "develop", following this model: follow this model for contributing: http://nvie.com/posts/a-successful-git-branching-model/
If you are part of the ccd-utexas organization, 
